        ...
        <div class="content content-narrow">
            ...
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">Tabela de Desfavorável período <kbd>{{ date('01/m/Y') }}</kbd> à <kbd>{{ date('t/m/Y') }}</kbd></h3>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <!-- export excel -->
                    <a href="{{ url('/backoffice/index/backofficeDesfavoravelExport/'.date("Y-m-01").' /'.date('Y-m-t')) }}"> <button class="btn btn-success" value="Excel" id="export" name="export"><span class="fa fa-download"></span> &ensp;Excel</button></a>
                    <!-- input datepicker -->
                </div>
