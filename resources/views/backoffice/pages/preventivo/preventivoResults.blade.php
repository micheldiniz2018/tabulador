        ...
        <div class="content content-narrow">
            ...
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">Tabela de acordos período <kbd>{{ date('d/m/Y', strtotime($saida['dtinicial'])) }}</kbd> à <kbd>{{ date('d/m/Y', strtotime($saida['dtfinal'])) }}</kbd></h3>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <!-- export excel -->
                    <a href="{{ url('/backoffice/index/preventivoExport/'.date("Y-m-d", strtotime($saida["dtinicial"])).'/'.date('Y-m-d', strtotime($saida['dtfinal']))) }}"> <button class="btn btn-success" value="Excel" id="export" name="export"><span class="fa fa-download"></span> &ensp;Excel</button></a>
                    <!-- input datepicker -->
                </div>
