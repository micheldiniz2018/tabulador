        ...
        <div class="content content-narrow">
            ...
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">Tabela de Desfavorável período <kbd>{{ date("d/m/Y", strtotime($saida["dtinicial"])) }}</kbd> à <kbd>{{date('d/m/Y', strtotime($saida['dtfinal'])) }}</kbd></h3>
                </div>

                <div class="col-lg-8">
                    <!-- Form Inline - Default Style -->
                    <form class="form-inline mb-4" action="{{  url('/backoffice/index/resultDesfavoravel/') }}" method="POST">
                        @csrf
                    ...
                    <!-- export excel -->
                    <a href="{{ url('/backoffice/index/backofficeDesfavoravelExport/'. date("Y-m-d", strtotime($saida["dtinicial"])) .'/'.date('Y-m-d', strtotime($saida['dtfinal']))) }}"> <button class="btn btn-success" value="Excel" id="export" name="export"><span class="fa fa-download"></span> &ensp;Excel</button></a>
                    <!-- input datepicker -->
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped js-dataTable-full-pagination">
                            ...
                            <tr>
                                ...
                                <th>Taxa Nova</th>
                                <th>Dias Atraso</th>
                                <th>Valor Parc Anterior</th>
                                <th>QTD Parc Anterior</th>
                                <th>Valor Parc Atual</th>
                                <th>QTD Parcela Atual</th>
                            </tr>
                            </thead>
                            <tbody>
