...
class PP extends Controller
{
    ...
    public function index()
    {
        ...
        $pp = RegistroOperador::join('tb_csc_pp','tb_csc_registro_operador.id','=','tb_csc_pp.id_pp_csc_fk')
            ->whereBetween('datareg', [date('Y-m-01'),date('Y-m-t') ])
            ->get();

        return view('backoffice.pages.preventivo.pp', compact('pp'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('backoffice.pages.preventivo.resultSearchPP', compact('pp', 'saida'));
    }
