...
class Desfavoravel extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $desfavoravel = RegistroOperador::join('tb_csc_desfavoravel','tb_csc_registro_operador.id','=','tb_csc_desfavoravel.id_desfavoravel_fk')
            ->whereBetween('datareg', [date('Y-m-01'),date('Y-m-t') ])
            ->get();

        return view('backoffice.pages.preventivo.desfavoravel', compact('desfavoravel'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('backoffice.pages.preventivo.resultSearchDesfavoravel', compact('desfavoravel', 'saida'));
    }
